  ...
  scenes: [
    {
      ...
      subtitle: "O catálogo inteligente das suas calls",
      kpis: [{ v: "112+", label: "gravações" }, { v: "10", label: "projetos" }, { v: "55", label: "frames/call" }],
      narration: "Meeting Library — o catálogo inteligente de todas as suas calls.",
    },
    {
      type: "screens",
    ...
    },
    {
      ...
      items: [
        ...
        { v: "24/7", label: "online", sub: "self-hosted", brand: "#DFB127" },
      ],
    ...
    },
    {
      ...
      groups: [
        ...
        { title: "Plataforma", items: [{ icon: "python", brand: "#3776AB", name: "Python", role: "server stdlib", tag: "backend" }, { icon: "linux", mono: true, brand: "#0B1723", name: "systemd", role: "hospedagem 24/7", tag: "self-hosted" }] },
      ],
      narration: "Por baixo: AssemblyAI e Gemini na inteligência, Python e systemd na plataforma.",
    },
    {
      type: "quote",
    ...
    },
    {
      type: "outro",
      title: "Meeting Library",
      url: "meet.yourdomain.com",
      tagline: "Todo o conhecimento das calls — buscável e seguro.",
      narration: "Meeting Library. Self-hosted, na sua própria infraestrutura.",
    },
  ],
};
